...
- Supporting research unit 1 (direct superior): Prof. Dr. Elizabeth Tilley, Associate Professor, Global Health Engineering, D-MAVT, ETH Zurich. [TODO insert Liz's room, postal address line, and email exactly as she uses them. Per the call, the grant account sits with this unit and Lars is the budget manager.]
- Supporting research unit 2: [TODO still to secure. The call requires a second letter from a group leader or head of unit, which may sit in another department or in a non-departmental unit. Candidates already familiar with the proposal: Julian Dederke (ETH Library, Data Stewardship Network) and Daniel Stekhoven (SwissRN ETH local node, NEXUS Personalized Health Technologies). Ask this week.]
...
- Recruitment risk: the programme needs fifteen committed participants. At the time of submission [TODO insert the number confirmed on 15 September] ETH researchers have committed to take part, recruited through an open call across the Data Stewardship Network, the RSE Network, ETH4D, D-USYS TdLab, and the ETH ORD community. Mitigation: the cohort design allows more doctoral students to take the senior places if those do not fill. Should places remain open at the start of the programme, we are confident of filling the cohort with the FAIR Coalition's support and reach at ETH Zurich, on the understanding that the Coalition sees the worth of the programme. The interest already shown suggests demand is not the constraint.
